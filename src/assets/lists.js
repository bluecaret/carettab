...
export const fontList = [
  ...
  { id: 'Big+Shoulders+Stencil+Display', label: 'Big Shoulders Stencil Display' },
  { id: 'Bitter', label: 'Bitter' },
  { id: 'Bungee+Hairline', label: 'Bungee Hairline' },
  { id: 'Cabin+Sketch', label: 'Cabin Sketch' },
  { id: 'Caveat', label: 'Caveat' },
  { id: 'Chakra+Petch', label: 'Chakra Petch' },
  { id: 'Chelsea+Market', label: 'Chelsea Market' },
  { id: 'Codystar', label: 'Codystar' },
  { id: 'Comfortaa', label: 'Comfortaa' },
  { id: 'Cute+Font', label: 'Cute Font' },
  ...
  { id: 'Lilita+One', label: 'Lilita One' },
  ...
  { id: 'Noto+Color+Emoji', label: 'Noto Color Emoji' },
  { id: 'Noto+Sans', label: 'Noto Sans' },
  { id: 'Noto+Sans+Symbols+2', label: 'Noto Sans Symbols 2' },
  ...
  { id: 'Signika+Negative', label: 'Signika Negative' },
  ...
  { id: 'Zilla+Slab', label: 'Zilla Slab' },
]
