...
function loadSettings(caretTabStatus, sLoad, data, loaded) {
  ...
  if (data.s1stLink != undefined) {
    s1stLink = data.s1stLink;
  }
  t1stLink(loaded);
  if (data.s1stLinkUrl != undefined) {
    s1stLinkUrl = data.s1stLinkUrl;
  }
  t1stLinkUrl(s1stLinkUrl, loaded);
  if (data.s1stLinkLabel != undefined) {
    s1stLinkLabel = data.s1stLinkLabel;
  }
  t1stLinkLabel(s1stLinkLabel, loaded);
  if (data.s2ndLink != undefined) {
    s2ndLink = data.s2ndLink;
  }
  t2ndLink(loaded);
  if (data.s2ndLinkUrl != undefined) {
    s2ndLinkUrl = data.s2ndLinkUrl;
  }
  t2ndLinkUrl(s2ndLinkUrl, loaded);
  if (data.s2ndLinkLabel != undefined) {
    s2ndLinkLabel = data.s2ndLinkLabel;
  }
  t2ndLinkLabel(s2ndLinkLabel, loaded);
  if (data.s3rdLink != undefined) {
    s3rdLink = data.s3rdLink;
  }
  t3rdLink(loaded);
  if (data.s3rdLinkUrl != undefined) {
    s3rdLinkUrl = data.s3rdLinkUrl;
  }
  t3rdLinkUrl(s3rdLinkUrl, loaded);
  if (data.s3rdLinkLabel != undefined) {
    s3rdLinkLabel = data.s3rdLinkLabel;
  }
  t3rdLinkLabel(s3rdLinkLabel, loaded);
  if (data.s4thLink != undefined) {
    s4thLink = data.s4thLink;
  }
  t4thLink(loaded);
  if (data.s4thLinkUrl != undefined) {
    s4thLinkUrl = data.s4thLinkUrl;
  }
  t4thLinkUrl(s4thLinkUrl, loaded);
  if (data.s4thLinkLabel != undefined) {
    s4thLinkLabel = data.s4thLinkLabel;
  }
  t4thLinkLabel(s4thLinkLabel, loaded);
  if (data.s5thLink != undefined) {
    s5thLink = data.s5thLink;
  }
  t5thLink(loaded);
  if (data.s5thLinkUrl != undefined) {
    s5thLinkUrl = data.s5thLinkUrl;
  }
  t5thLinkUrl(s5thLinkUrl, loaded);
  if (data.s5thLinkLabel != undefined) {
    s5thLinkLabel = data.s5thLinkLabel;
  }
  t5thLinkLabel(s5thLinkLabel, loaded);
  if (data.s6thLink != undefined) {
    s6thLink = data.s6thLink;
  }
  t6thLink(loaded);
  if (data.s6thLinkUrl != undefined) {
    s6thLinkUrl = data.s6thLinkUrl;
  }
  t6thLinkUrl(s6thLinkUrl, loaded);
  if (data.s6thLinkLabel != undefined) {
    s6thLinkLabel = data.s6thLinkLabel;
  }
  t6thLinkLabel(s6thLinkLabel, loaded);
